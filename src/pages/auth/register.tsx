...
export const RegisterPage: React.FC<RegisterProps> = ({
  ...
  const PageTitle =
    title === false ? null : (
      ...
      >
        {title ?? <ThemedTitleV2 text="ElectionHub" icon={<AppIcon />} collapsed={false} /> }
      </div>
    );
    ...
    >
      ...
      {!hideForm && (
        ...
        >
          <Form.Item
              name="full_name"
              label={translate("pages.register.full_name", "Prénom Nom")}
              rules={[
                  { required: true },
                  {
                      type: "string",
                      message: translate(
                          "pages.register.errors.validFull_name",
          ...
          >
              <Input
                  ...
                  placeholder={translate(
                      "pages.register.fields.full_name",
                      "Prénom Nom",
                  )}
              />
          </Form.Item>
